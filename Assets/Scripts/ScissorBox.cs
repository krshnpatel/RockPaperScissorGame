...
public class ScissorBox : MonoBehaviour
{
	...
	void PlayAnimation (Animator anim, string animName, string result, GameObject go = null)
	{
		...
		{
			this.gameObject.GetComponent<Animator>().CrossFade ("ScissorBoxKill", 0f);
